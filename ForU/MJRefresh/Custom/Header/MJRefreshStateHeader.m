...
- (void)placeSubviews
{
    ...
    if (self.lastUpdatedTimeLabel.hidden) {
        ...
        self.stateLabel.mj_y = 64;
        self.stateLabel.mj_w = self.mj_w;
        self.stateLabel.mj_h = self.mj_h * 0.5;
        
        // 更新时间
        self.lastUpdatedTimeLabel.mj_x = 0;
        self.lastUpdatedTimeLabel.mj_y = self.stateLabel.mj_h+64;
        self.lastUpdatedTimeLabel.mj_w = self.mj_w;
        self.lastUpdatedTimeLabel.mj_h = self.mj_h - self.lastUpdatedTimeLabel.mj_y+64;
    }
}
